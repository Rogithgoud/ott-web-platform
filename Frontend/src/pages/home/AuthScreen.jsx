...
import { ChevronRight } from "lucide-react"; // A component from lucide-react for adding an icon to the "Get Started" button.
			...
			<div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
					...
					<div className='flex-1 relative'>
						<img src='/tv.png' alt='Tv image' className='mt-4 z-30 relative' />
						<video
